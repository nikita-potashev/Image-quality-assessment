...
class NoiseModelTrainer(BaseTrain):
    def __init__(self, model, data, config):
        super(NoiseModelTrainer, self).__init__(model, data, config)
        self.callbacks = []
        self.loss = []
        self.acc = []
        self.val_loss = []
    ...
    def visualize(self):
        ...
        plt.legend()
        plt.savefig(os.path.join(self.config.visual_dir,
                                 '{}.pdf'.format(self.config.exp_name)))
